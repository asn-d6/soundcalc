...
def get_FRI_query_phase_error(theta: float, s: int) -> float:
    """
    Compute the soundness error for `s` queries.
...
def get_FRI_soundness_error(
    ...
    e_FRI_query_phase = get_FRI_query_phase_error(theta, params.s)
